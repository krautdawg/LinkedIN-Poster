...
class ContentGenerator:
    ...
    def _generate_post_content(content: str) -> str:
        ...
        response = openai.chat.completions.create(
            ...
            messages=[
    {"role": "system", "content": "You are a professional content strategist and copywriter. Your task is to analyze the provided news article (URL and description will be shared) and create an engaging LinkedIn post that reflects its key insights. Focus specifically on how the article's AI-related content is relevant for SMBs. Reference the article's main points in your response."},
